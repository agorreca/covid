...
export default class TigreTotalCasesChart extends React.Component {
    constructor(props) {
        super(props);
        const values = TigreData.map(item => ({x: new Date(Date.parse(item.date)), y: item.cases.total})).reverse();
